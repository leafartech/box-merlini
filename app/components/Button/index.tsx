...
export default function Button({ children }: ButtonProps) {
    return (
        <div className="flex justify-center w-full">
            <a href="https://api.whatsapp.com/send?phone=554233235059&text=Ol%C3%A1,%20tudo%20bem?%20" className="bg-red-500 text-center rounded-lg w-full sm:max-w-sm text-white font-semibold flex items-center gap-2 py-3 px-6 sm:text-lg" id="wpp_btn">
                <svg xmlns="http://www.w3.org/2000/svg" className="xs w-4 h-4 sm:w-6 sm:h-6 mt-1 sm:mt-0" viewBox="0 0 24 24" fill="none">
