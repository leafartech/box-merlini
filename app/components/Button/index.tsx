...
export default function Button({ children }: ButtonProps) {
    return (
        <div className="flex justify-center w-full">
            <a href="https://api.whatsapp.com/send?phone=554233235059&text=Ol%C3%A1,%20tudo%20bem?%20" className="bg-red-500 text-center rounded-lg w-full sm:max-w-sm text-white font-semibold flex items-center gap-2 py-3 px-6 sm:text-lg">
