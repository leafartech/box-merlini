...
export default function Card({ inverse, children, description, title }: CardProps) {
    return (
        <div className={`bg-clip-padding backdrop-filter backdrop-blur-sm border border-zinc-600 sm:border-zinc-800 flex flex-col items-start justify-start text-left gap-3 group py-12 px-8 w-full sm:w-[280px] h-[200px] transition duration-200 hover:scale-105 rounded-xl ${inverse ? 'grad-radial-inverted' : 'grad-radial'}`}>
