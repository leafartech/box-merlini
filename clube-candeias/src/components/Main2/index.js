...
export default function Main() {
    ...
    useEffect(() => {
        if (cont === 0) {
            ...
            script.src = 'https://lauromts.activehosted.com/f/embed.php?id=3';
        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <Section bg={true} pd={true}>
                    ...
                    <Text main="Veja os exemplos abaixo:" bg={true}></Text>
                    ...
                    <Text bg={true}>
                        <p style={{ marginTop: '12px', maxWidth: '370px' }}>Se cadastrando hoje, garantimos essa condição especial.</p>
                    </Text>
                </Section>
