        ...
        <main className={ styles.main }>
            <Section bg={true} top={true}>
                ...
                <div className={ styles['card-group']}>
                    <Card city="Balneário Camboriú" path="1">Apartamento mobiliado acomoda até 10 pessoas (diárias a partir de R$35) Hotel a partir de R$45 reais</Card>
                    ...
                    <Card city="Gramado" path="4">Diárias a partir de R$ 65 reais</Card>
                    <Card city="Village do Sol em Natal/RN" path="5">Um hotel 5 estrelas. Fica em um bosque de coqueiros. A unidade possui quartos de hotel e também 27 chalés. Com diárias Diária a partir de R$69 reais</Card>
                    <Card city="Hotel Guarany em Bonito/MS" path="6">(Pontos turísticos: aquário natural nada com os peixes, buraco das araras, gruta da lagoa azul). A partir de R$43 reais</Card>
                    <Card city="Foz do Iguaçu/PR" path="7">Diárias a partir de R$43 reais</Card>
                    <Card city="Guarujá" path="8">(Pontos turísticos: AQUÁRIO NATURAL NADA COM OS PEIXES, BURACO DAS ARARAS, GRUTA DA LAGOA AZUL). Hotel recém inaugurado com piscina!</Card>
                </div>
            </Section>
            <Section pd={true}>
